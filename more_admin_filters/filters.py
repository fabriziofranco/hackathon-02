...
class DepartmentDropdown(AllValuesFieldListFilter):
    """
    Dropdown filter for all kind of fields.
    """
    template = 'more_admin_filters/departmentdropdownfilter.html'


class RegionDropdown(AllValuesFieldListFilter):
    """
    Dropdown filter for all kind of fields.
    """
    template = 'more_admin_filters/regiondropdownfilter.html'
